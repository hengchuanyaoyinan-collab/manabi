...
| Supabase Edge Function: `create-checkout-session` (verify_jwt = true, v4: idempotency key + 金額上限) | ✅ デプロイ済み |
| Supabase Edge Function: `stripe-webhook` (verify_jwt = false, v3: dispute 対応追加) | ✅ デプロイ済み |
